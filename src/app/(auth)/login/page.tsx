  ...
  return (
    <div className="min-h-screen bg-neutral-950 text-neutral-200 flex flex-col justify-center items-center p-6 selection:bg-white/10">
      <div className="mb-8 text-center text-white">
        ...
        <p className="text-neutral-500 text-sm">Welcome back to the portal</p>
      </div>
        ...
        <form onSubmit={handleLogin} className="space-y-6">
          ...
          <div className="space-y-2">
            <div className="flex justify-between items-center pl-1">
              <label className="text-[10px] font-bold text-neutral-500 uppercase tracking-[0.2em]">
                Password
              </label>
              <Link
                href="#"
          ...
          <button
            type="submit"
            disabled={loading}
            className="w-full bg-indigo-600 hover:bg-indigo-500 text-white font-bold py-3 rounded-xl transition-all flex justify-center items-center gap-2 group disabled:opacity-50 disabled:cursor-not-allowed shadow-lg shadow-indigo-500/10"
          >
            {loading ? (
